...
for (exp in unique(mydata$experiment)){
  ...
  png(paste("found", exp, "scenario_agg.png", sep="-"),width = 800)
  ...
  png(paste("found", exp, "network_agg.png", sep="-"),width = 800)
