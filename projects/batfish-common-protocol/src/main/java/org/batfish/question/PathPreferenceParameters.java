...
public final class PathPreferenceParameters {
  ...
  public static class Builder {
    ...
    public PathPreferenceParameters build() {
      return new PathPreferenceParameters(this);
    }
  ...
  private PathPreferenceParameters(Builder builder) {
