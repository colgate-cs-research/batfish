...
class TransferSSA {
  ...
  private TransferResult<BoolExpr, BoolExpr> compute(
    ...
    pCur.debug(expr.toString());
    System.out.println("Warning: use of unimplemented feature " + expr.toString());
    return fromExpr(_enc.mkTrue());
  ...
  private TransferResult<BoolExpr, BoolExpr> compute(
    ...
    for (Statement stmt : statements) {
      ...
      if (stmt instanceof StaticStatement) {
        ...
        curP.debug(stmt.toString());
        System.out.println("Warning: use of unimplemented feature " + stmt.toString());
